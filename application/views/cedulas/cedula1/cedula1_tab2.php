...
<?php echo form_open('','id="frmTab3"'); ?>
	...
	<table class="table table-bordered" id="table200" name="table200">
		<tr>
			...
			<th colspan="11" ><h4><center>200. CARACTERISTICAS DE LOS MIEMBROS DEL HOGAR </center></h4> </th>
		</tr>
		...
		<tfoot><tr><td colspan="13"><?php echo form_button('addRowTable200','Agregar fila','id="addRowTable200"'); ?><input type="hidden" id="numRowsTable200" name="numRowsTable200" value="0"></td> </tr> </tfoot>
	</table>
