...
$('#E2_109').change(function(event) 
{
	if ( $('#E2_109').val()=='2' ) 
	{

		$('.educativos').attr( 'disabled', 'disabled');
	}
	else
	{
		$('.educativos').removeAttr('disabled');
...
$('#E2_111').change(function(event)
{
	if( $('#E2_111').val()=='2' )
	{
		$('.establecimientos').attr( 'disabled', 'disabled');

	}
	else
	{
		$('.establecimientos').removeAttr('disabled');
	}
});
