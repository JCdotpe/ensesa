...
*******************************************************************************/
	...
	$arrayProvincia = array('-1'=> " Seleccione");
	$arrayDistrito = array('-1'=> " Seleccione");
...
<?php echo form_open('','id="frmTab1"'); ?>
	...
	<?php echo form_submit('find1','Buscar','id="find1"'); ?>
	...
	<table id="tableVisita" name="tableVisita" class="table table-bordered"><!-- visita -->
		<tr>
	...
	<table class="table table-bordered tableSerialized"><!-- D: funcionarios -->
		<tr>
	...
	<table class="table table-bordered tableSerialized"><!-- CAP 100 -->
